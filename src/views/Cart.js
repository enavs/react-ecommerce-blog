        ...
        return (
            <div>
                ...
                <div className="card-body">
                    ...
                    {/* <!-- CART ITEMS : begin --> */}
                    <CartList cart={this.props.cart} cartTotal={this.props.cartTotal} handleRemoveFromCart={this.props.handleRemoveFromCart} getCountOfProduct={this.props.getCountOfProduct} />
                    {/* <!-- CART ITEMS : end --> */}
                ...
                <div className="card-footer">
                    ...
                    <div className="pull-right" style={{ margin: "10px" }}>
                        ...
                        <div className="pull-right" style={{ margin: "5px" }}>
                            Total price: <b>${this.props.cartTotal}</b>
                        </div>
                    </div>
                </div>
            </div>
